...
SUPPLY_CHAIN_BLUEPRINTS: Dict[str, dict] = {
    ...
    "스마트폰/가전": {
        "imports": ["모바일 AP", "이미지센서", "OLED 패널", "카메라 모듈"],
        "exports": ["북미/유럽 완제품", "동남아 통신사/리테일"],
        "logistics": ["광저우-인천 항공", "하노이-김포 항공", "부산-로테르담 해상"],
        "alerts": ["미국/일본의 대중 수출 규제", "중국 봉쇄로 ODM 중단"],
    },
    "조선/해양": {
        "imports": ["고망간 후판", "저온 밸브", "메인 엔진"],
        "exports": ["카타르/LNG선 프로젝트", "유럽 선주 인도"],
        "logistics": ["포항 내륙 운송", "거제-유럽 시운전 항로"],
        "alerts": ["홍해/말라카 해상 위험", "러시아 제재로 LNG 기자재 지연"],
    },
    "에너지/정유": {
        "imports": ["중동 원유", "북미 경질", "카타르 LNG"],
        "exports": ["아시아 경유/휘발유", "미국/유럽 석유화학"],
        "logistics": ["라스탄누라-울산 VLCC", "카타르-평택 LNG선"],
        "alerts": ["OPEC+ 감산", "호르무즈 긴장"],
    },
    "식품/소비재": {
        "imports": ["브라질 곡물", "동남아 팜유", "스위스 향료"],
        "exports": ["동북아 리테일", "미국 K-푸드", "동남아 프랜차이즈"],
        "logistics": ["산투스-부산 벌크", "조호르-인천 냉장 컨테이너"],
        "alerts": ["곡물 수출 금지", "식품 안전 규제"],
    },
    "물류/상사": {
        "imports": ["해상 슬롯", "항공 슬롯", "항만 창고"],
        "exports": ["글로벌 제조사 SCM", "동남아/미국 B2B 물류"],
        "logistics": ["부산-로테르담 컨테이너", "싱가포르 환적"],
        "alerts": ["컨테이너 운임 급등", "항만 파업"],
    },
}
