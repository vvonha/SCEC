...
Reddit · BBC · Reuters · AP · Al Jazeera · Yonhap · The Guardian · Deutsche Welle · New York Times · VOA · CNN · NPR · Sky News · NHK 등 다중 뉴스 피드에서 감지한 분쟁 국가쌍과 자동 매칭해 공급망 리스크 리포트를 만들어 주는 로컬 웹 앱입니다. 위키/뉴스 검색과 카테고리별 공급망 디렉터리를 조합해 실제 공급 파트너와 대체 제조사를 실명으로 제시합니다.
...
4. Reddit r/worldnews, BBC, Reuters, AP, Al Jazeera, 연합뉴스, Guardian, DW, NYT, VOA, CNN, NPR, Sky News, NHK RSS 헤드라인과 지정학 시나리오 라이브러리를 결합해 분쟁 국가쌍을 생성합니다.
...
- `conflict_fetcher.py` – Reddit/BBC/Reuters/AP/Al Jazeera/연합뉴스/The Guardian/DW/NYT/VOA/CNN/NPR/Sky/NHK RSS 헤드라인과 지정학 라이브러리를 통합해 분쟁 국가쌍을 구성합니다.
