...
Reddit · BBC · Reuters · AP · Al Jazeera · Yonhap · The Guardian · Deutsche Welle 등 다중 뉴스 피드에서 감지한 분쟁 국가쌍과 자동 매칭해 공급망 리스크 리포트를 만들어 주는 로컬 웹 앱입니다. 위키/뉴스 검색을 통해 실제 공급 파트너와 대체 제조사를 실명으로 제시합니다.
...
4. Reddit r/worldnews, BBC, Reuters, AP, Al Jazeera, 연합뉴스, Guardian, DW RSS 헤드라인에서 국가 키워드를 감지해 분쟁 국가쌍을 생성합니다.
5. 품목–분쟁–공급사 매칭을 통해 위험 포인트, 대체 공급국, 수입선 의존도, 경보 메시지를 계산하고 반응형 UI로 시각화합니다.
...
- `conflict_fetcher.py` – Reddit/BBC/Reuters/AP/Al Jazeera/연합뉴스/The Guardian/DW RSS 헤드라인에서 국가 키워드를 탐지해 분쟁 국가쌍을 구성합니다.
